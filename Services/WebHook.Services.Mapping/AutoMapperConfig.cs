namespace WebHook.Services.Mapping
{
    ...
    public static class AutoMapperConfig
    {
        ...
        {
            return MapperInstance.Map<TDestination>(value);
        }
        public static List<TDestination> MapToList<TDestination>(this object value)
        {
            return MapperInstance.Map<List<TDestination>>(value);
        }
        ...
        public static void RegisterMappings(params Assembly[] assemblies)
        {
            ...
            config.CreateProfile(
                ...
                configuration =>
                {
                    ...
                    configuration.CreateMap<DeliveryInfo, DeliveryInfoDto>();
                });
